export const MYSQL_LIFECYCLE_FIELDS = {
  ...
  tableEngine: 'ENGINE',
  tableRowFormat: 'ROW_FORMAT',
  columnName: 'column_name',
  columnType: 'data_type',
  columnNotNull: 'not_null',
  columnDefault: 'column_default',
  columnComment: 'comment',
  columnMaxLength: 'character_maximum_length',
  columnIdentity: 'is_identity',
...
export const MYSQL_LIFECYCLE_PREVIEW = {
  ...
  createTableEngine: /ENGINE=InnoDB/i,
  autoIncrement: /AUTO_INCREMENT/i,
  changeColumnLength: /CHANGE COLUMN[\s\S]*CHAR\(12\)/i,
  recreateIndex: /DROP INDEX[\s\S]*CREATE[\s\S]*INDEX/i,
