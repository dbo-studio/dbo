...
export const POSTGRES_LIFECYCLE_PREVIEW = {
  ...
  addForeignKey: /ADD CONSTRAINT[\s\S]*FOREIGN KEY[\s\S]*ON UPDATE CASCADE[\s\S]*ON DELETE CASCADE/i,
  editForeignKey: /RENAME CONSTRAINT[\s\S]*TO/i,
  ...
  alterColumnLength: /ALTER COLUMN[\s\S]*TYPE character varying\(128\)/i,
