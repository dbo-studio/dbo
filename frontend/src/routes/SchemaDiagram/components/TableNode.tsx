        ...
        >
            ...
            >
                ...
                <Tooltip title='Edit Table'>
                    <IconButton size='small' onClick={handleEditTable} sx={{ color: 'inherit' }} onMouseDown={(e) => e.stopPropagation()}>
                        <Edit size={16} />
                    </IconButton>
                </Tooltip>
            </Box>
                ...
                {table.columns.map((column) => (
                    ...
                    >
                        ...
                        <Box display='flex' gap={0.5}>
                            ...
                            {column.notNull && (
                                <Chip label='NN' size='small' sx={{ height: 18, fontSize: '0.65rem' }} />
                            )}
                        </Box>
                        ...
                        >
                            <Tooltip title='Edit Column'>
                                <IconButton
                                    size='small'
                                    onClick={(e) => handleEditColumn(e, column.name)}
                                    sx={{ p: 0.25 }}
                                >
                                    <Edit size={14} />
                                </IconButton>
