        ...
        >
            ...
            {!file ?
                <Typography color="textText" variant="caption">
                    {locales.drag_and_drop_file} <Typography color="textPrimary" variant="caption">{locales.browse}</Typography>
                </Typography>
                :
                <Typography color="textPrimary" variant="caption">{file.name}</Typography>
            }
