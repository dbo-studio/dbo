...
For public deployment, set `APP_PUBLIC_URL`, `APP_AUTH_TOKEN`, and `APP_ALLOWED_ORIGINS` — see [Configuration](configuration.md) and [Security](security.md).
...
APP_AUTH_TOKEN=<at-least-32-char-secret>
