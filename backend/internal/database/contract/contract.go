...
type DatabaseRepository interface {
	...
	GetFormFields(ctx context.Context, nodeID string, tabID TreeTab, action TreeNodeActionName) []FormField
	Objects(ctx context.Context, nodeID string, tabID TreeTab, action TreeNodeActionName) ([]FormField, error)
