...
func NewPostgresRepository(ctx context.Context, connection *model.Connection, cm *databaseConnection.ConnectionManager, deps databaseCore.DriverDeps) (contract.DatabaseRepository, error) {
